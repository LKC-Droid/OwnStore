...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE tienda(id_tienda INTEGER PRIMARY KEY AUTOINCREMENT, nombre_tienda TEXT, descripcion_tienda TEXT,imagen_tienda text,direccion_tienda text);");
